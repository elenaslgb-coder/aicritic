...
const SYSTEM_PROMPT = `
Ты — венчурный инвестор с опытом.
Анализируй бизнес-идеи профессионально, по существу.
Без подбадривания и без излишней резкости.
Всегда отвечай только на русском языке, независимо от языка идеи.
...
По 3 пункта в каждом массиве.
Формулируй конкретно, без воды.
...
app.listen(PORT, () =>
  console.log(`AI-критик готов на порту ${PORT}`)
);
